...
GREP -Es "Name=@\{Microsoft\.(Bing|Todos|Zune)|Name=@\{(Clipchamp|AD2F1837)\." <temp00 >temp01
IF ERRORLEVEL 1 ( GOTO :FirewallOrphans )
...
GREP -Eis "^Microsoft\.(549981C3F5F10|Advertising|Bing|Client\.WebExperience|Copilot|DiagnosticDataViewer|Microsoft3DViewer|MicrosoftEdge|MicrosoftOfficeHub|MicrosoftPCManager|MixedReality|OneConnect|People|ScreenSketch|Services\.Store\.Engagement|Todos|WidgetsPlatformRuntime|WindowsAlarms|WindowsFeedbackHub|Windows\.Ai\.Copilot|YourPhone|Zune)" <"%TEMP%\privwindozelogp.txt" >"%TEMP%\privwindozelogp_found.txt"
